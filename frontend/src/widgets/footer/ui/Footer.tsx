...
export const Footer = () => {
  ...
  return (
    <footer className="bg-primary-black-500 py-8 mt-auto tablet:py-10 print:hidden">
      <Container>
        <div className="flex flex-col tablet:flex-row justify-between items-center gap-6">
          <div className="text-caption-regular text-primary-white-400">
            <p>© 2026 ẃ1lq. Все права защищены.</p>
          ...
          <div className="flex gap-6">
            <Button
              ...
              aria-label="Наверх"
            >
              <ArrowRightIcon className='-rotate-90 w-5 h-5' aria-hidden="true" />
