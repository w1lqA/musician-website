...
const HomeHero = ({ className }: Props) => {
    ...
    return (
        <section ref={targetRef} className={`${className} pt-36 pb-16 tablet:pb-36 relative overflow-hidden print:pt-8 print:pb-8 print:overflow-visible`}>
            <motion.div className="absolute inset-0 z-0 print:hidden" style={{ y: backgroundY }}>
            ...
            <Container>
                <div className="grid grid-cols-1 tablet:grid-cols-16 gap-5 items-center relative z-10 print:grid-cols-1 print:gap-2">
                    <motion.div
                        className="tablet:col-span-6 space-y-6 tablet:space-y-8 text-center tablet:text-left print:space-y-2"
                        style={{ y: textY, opacity: textOpacity }}
                    >
                        <motion.h2
                            className="text-h2-display-bold tablet:text-h1-display-bold text-primary-white-600 uppercase print:text-black print:text-h4-display-bold"
                        ...
                        <motion.p
                            className="text-title2-regular text-primary-white-500 print:text-black print:text-body-regular"
                            initial={{ opacity: 0, x: -50 }}
                            animate={{ opacity: 1, x: 0 }}
                        ...
                        >
                            <Button size="small" variant='primary' className="w-full px-12 print:hidden">
                                Слушать
                            </Button>
                        </motion.div>
                    </motion.div>

                    <div className="relative tablet:col-start-8 tablet:col-span-9 aspect-square tablet:aspect-[710/549] flex items-center justify-center print:hidden">
                        <motion.div
                            className='absolute w-32 h-32 bg-accent-1/20 rounded-full -z-0 -top-10 -right-10 blur-2xl'
                            style={{ x: decorativeBlockX, y: decorativeBlockY }}
                        />
                        ...
                        <div className='absolute inset-0 w-full h-full items-center'>
                            <div className='flex h-full w-full items-center justify-center relative overflow-hidden'>
                                ...
                                <motion.button
                                    ...
                                    animate={{
                                        y: [0, -10, 0],
                                        boxShadow: ['0 0 0 0 rgba(163,62,68,0.4)', '0 0 0 20px rgba(163,62,68,0)', '0 0 0 0 rgba(163,62,68,0.4)']
                                    }}
                                    transition={{
